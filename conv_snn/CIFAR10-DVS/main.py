...
if __name__ == '__main__':
    #main() #原本的函数
    # 我的测试1：
    # data0 = torch.rand(2, 10, 2, 128, 128)
    # model = Spatial_CNN(nb_epochs=10,
    #                     lr=0.001,
    #                     batch_size=2,
    #                     resume=1,
    #                     start_epoch=1,
    ...
    #                     test_loader=None,
    #                     test_video=None)
    # model=models.Point_MAE()
    # output = model.model(data0.cuda())
    # print(output.shape)
    # 我的测试2:
    #
    config=cfg_from_yaml_file('Point_MAE\cfgs\pretrain.yaml')
    print(config)
    pts = torch.rand(2, 10, 2, 128, 128)
    model=Point_MAE.Point_MAE(config)